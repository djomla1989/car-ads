...
class CarMakes {
    ...
    protected static $db_fields=array('car_makes_id','car_name');
    ...
    $result_array = self::find_by_sql("SELECT * FROM ".self::$table." WHERE car_makes_id={$id} LIMIT 1");
 ...
 public static function count_all() {
	...
	protected function sanitized_attributes() {
	  ...
	  return $clean_attributes;
         ...
         public static function add_makes($name)
                    {
                        global $database;
                        ...
                        if(preg_match($car_name_reg,$name))
                                {
                                    $name=ucfirst($name);
                                    $sql="INSERT INTO ".self::$table." VALUES('','$name')";
