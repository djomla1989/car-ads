	...
	<div id="content">
		...
		<div id="main">
                    ...
                    if(isset($_POST['Register']))
                      ...
                      $poruka = $new_user->provera($_POST['password_confirmation']);
                       }
                          ?>
                    ...
                    <div class="box">
                        <form name="registracija" method="POST" action="<?php print $_SERVER['PHP_SELF']; ?>"
                            ...
                            <tr style=" width: 100%" >
                                <td colspan="2" style="text-align:center; font-size: 14px;padding: 10px 0px 10px 30px;">
                                    <strong>Registracija</strong></td>
                         </tr>
                            <tr>
                               <td>Korisnicko ime: <span class="zvezdica">*</span>  </td>
                               <td><input type="text" name="username"/></td>
                            </tr>
                           <tr>
                               <td>Sifra: <span class="zvezdica">*</span></td>
                               <td><input type="password" name="password"/></td>
                            </tr>
                           <tr>
                               <td>Ponovite Sifru: <span class="zvezdica">*</span></td>
                               <td><input type="password" name="password_confirmation"/></td>
                            </tr>
                             <tr>
                               <td>E-mail adresa: <span class="zvezdica">*</span></td>
                        ...
                        <?php if(isset($poruka))
                            echo "<span id='span_obavestenje' style='padding-left:195px'>{$poruka}</span>"?>
				<div class="cl">&nbsp;</div>
			</div>
