<div id="header">
		<!-- Logo -->
		<h1 id="logo"><a href="#">autoNesto your friend on the road</a></h1>
		<!-- End Logo -->
		...
		<div id="nav">
			<ul>
			    ...
			    <li><a href="contact.php" <?php echo ($_SERVER['PHP_SELF']=='/DiplomskiRad/public/contact.php' ? "class='active'":''); ?> >Kontakt</a></li>
                            <li><a href="register.php" <?php echo ($_SERVER['PHP_SELF']=='/DiplomskiRad/public/register.php' ? "class='active'":''); ?> >Registracija</a></li>
                            <?php
                            if(isset($_SESSION['username']) && $_SESSION['user_status']==1)
                                {
                                ?>
                                      <li><a href="admin/admin.php" <?php echo ($_SERVER['PHP_SELF']=='/DiplomskiRad/public/admin/admin.php' ? "class='active'":''); ?> >Admin</a></li>
                                <?php
                                      }
                                ?>
			</ul>                  
